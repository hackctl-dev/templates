# SvelteKit Supabase Template Guide

This file is specific to the `sveltekit-supabase` template.

## hackctl Context

- This template is scaffolded by `hackctl create --template sveltekit-supabase`.
